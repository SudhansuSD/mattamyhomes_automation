...
- Location: tests/communityPage.spec.ts:129:11

# Error details

```
Error: Primary community form not present on the community page
```
      ...
      - generic:
        - generic:
          - generic:
            ...
            - generic [ref=f24e3]:
              - generic [ref=f24e4]:
                - application "AtlasRTX Digital Assistant" [ref=f24e5]:
                  - generic [ref=f24e7]: Ask me about homes!
                - button "Request Tour" [ref=f24e9] [cursor=pointer]
                - button "Look For a Home" [ref=f24e11] [cursor=pointer]
                - button "Request Info" [ref=f24e13] [cursor=pointer]
              - img "AtlasRTX Digital Assistant icon" [ref=f24e15]:
                - text: Chat with Us
                - strong [ref=f24e18]: "1"
            - button [ref=f24e19]
```
