      ...
      - generic:
        - generic:
          - generic:
            - button [ref=f4e2]
            - generic [ref=f4e3]:
              - button "Close" [ref=f4e4]:
                - img [ref=f4e6]
              - application "AtlasRTX Digital Assistant" [ref=f4e9]:
                - generic [ref=f4e11]: Good afternoon! I am Tammy, Mattamy's digital assistant, here to help with your home search. How can I assist you today?
              - img "AtlasRTX Digital Assistant icon" [active] [ref=f4e13] [cursor=pointer]:
                - text: Chat with Us
                - strong [ref=f4e16]: "1"
            - button [ref=f4e17]
```
