...
Call log:
  ...
  - attempting click action
    2 × waiting for element to be visible, enabled and stable
      ...
      - done scrolling
      - <iframe id="iAtlasChat" allowfullscreen="" title="AtlasRTX Digital Assistant" src="https://assistant.atlasrtx.com/ui/6E746BD617314F59BA3FAEE363C8DDDA"></iframe> from <div id="iAtlasChatDiv">…</div> subtree intercepts pointer events
...
- generic [active] [ref=e1]:
  ...
  - iframe [ref=e253]:
    - dialog "AtlasRTX Digital Assistant" [ref=f3e3]:
      - generic [ref=f3e4]:
        - generic [ref=f3e5]:
          - button "Language" [ref=f3e7] [cursor=pointer]:
            - img [ref=f3e8]
            - generic [ref=f3e10]: English
          - img "AtlasRTX Digital Assistant and User icon" [ref=f3e12]
          - generic [ref=f3e14]:
            - button "Menu" [ref=f3e16] [cursor=pointer]:
              - img [ref=f3e17]
            - button "Close" [ref=f3e19] [cursor=pointer]:
              - img [ref=f3e20]
        - generic [ref=f3e22]: Tammy
      - log [ref=f3e24]:
        - generic [ref=f3e25]:
          - generic [ref=f3e28]:
            - generic [ref=f3e29]:
              - generic [ref=f3e30]: Tammy
              - generic [ref=f3e31]: "| 02:16 PM"
            - generic [ref=f3e32]: Good afternoon! I am Tammy, Mattamy's digital assistant, here to help with your home search.
          - generic [ref=f3e35]: How can I assist you today?
          - generic [ref=f3e38]:
            - generic [ref=f3e39]: Button Group
            - button "Look for a Home" [ref=f3e41] [cursor=pointer]
            - button "About Mattamy" [ref=f3e43] [cursor=pointer]
            - button "Current Mattamy Home Owner Resources" [ref=f3e45] [cursor=pointer]
      - status [ref=f3e46]
      - generic [ref=f3e47]:
        - generic:
          - textbox "Please select a button" [disabled]
        - generic [ref=f3e50]:
          - text: Powered by
          - link "Visit Verse.ai (opens in a new tab)" [ref=f3e51]:
            - /url: https://verse.ai/ai-powered-by-verse/
            - text: Verse.ai
```
