...
- Name: homePage.spec.ts >> Mattamy Homes - CAN >> Search >> @smoke @regression | CAN | Search market functionality should work
- Location: tests/homePage.spec.ts:56:9
    ...
    - generic [active] [ref=f11e1]:
      - generic:
        - generic:
          - generic:
            - button [ref=f11e2]
            - img "AtlasRTX Digital Assistant icon" [ref=f11e5] [cursor=pointer]: Chat with Us
            - button [ref=f11e7]
```
