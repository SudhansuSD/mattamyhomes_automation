...
Call log:
  - waiting for locator('input[placeholder*="Search"]:not(#vendor-search-handler):visible').first()
    - locator resolved to <input type="text" id="mastheadSeachBox" placeholder="Search by City, Community, Plan, or QMI name" class="font-graphie text-mattamy-gray bg-white h-60-mattamy px-5 md:px-10 w-full h-full rounded"/>
          ...
          - generic:
            ...
            - generic [ref=f3e3]:
              ...
              - application "AtlasRTX Digital Assistant" [ref=f3e9]:
                - generic [ref=f3e11]: Good evening! I am Tammy, Mattamy's digital assistant, here to help with your home search. How can I assist you today?
              - img "AtlasRTX Digital Assistant icon" [active] [ref=f3e13] [cursor=pointer]:
                - text: Chat with Us
                - strong [ref=f3e16]: "1"
            - button [ref=f3e17]
```
